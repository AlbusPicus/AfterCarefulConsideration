package com.albuspicus.accbingo.delegates
 ...
 * Also you can apply synthetics methods of kotlin android extensions for [SmartDelegate.ViewHolder]
 * So you can override only [onBindViewHolder] method in children of this class.
 */
@DataTypeUndeclared
abstract class SmartDelegate<T, B: ViewBinding>(
        private val bindingCreator: (inflater: LayoutInflater, container: ViewGroup) -> B
    ...
    override fun onCreateViewHolder(parent: ViewGroup) =
        ViewHolder(bindingCreator(LayoutInflater.from(parent.context), parent))
